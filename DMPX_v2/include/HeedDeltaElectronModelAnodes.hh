...
class HeedDeltaElectronModelAnodes : public HeedModel {
  public:
   //-------------------------
   // Constructor, destructor
   //-------------------------
   HeedDeltaElectronModelAnodes(GasModelParameters *,G4String, G4Region*,DetectorConstruction*, AnodesSD*);
   ~HeedDeltaElectronModelAnodes();
