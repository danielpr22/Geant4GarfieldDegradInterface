...
int main(int argc, char** argv) {
  ...
  if (argc == 1)  //! define UI terminal for interactive mode:
  {
    ...
    UImanager->ApplyCommand("/control/execute G_factor.mac");
    ...
    std::vector<double> voltages = {200.0, 400.0, 600.0, 800.0, 1000.0, 1200.0, 1400.0,
      1600.0, 1800.0, 2000.0, 2200.0, 2400.0}; // in V

    for (double voltage : voltages) {
        UImanager->ApplyCommand("/gasModelParameters/heed/voltageanodewire " + std::to_string(voltage) + " V");
