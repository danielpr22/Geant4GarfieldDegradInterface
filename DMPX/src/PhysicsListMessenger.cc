...
PhysicsListMessenger::PhysicsListMessenger(PhysicsList* pPhys)
  ...
  gammaCutCmd = new G4UIcmdWithADoubleAndUnit("/DMPX/phys/setGCut", this);
  ...
  electCutCmd = new G4UIcmdWithADoubleAndUnit("/DMPX/phys/setECut", this);
  ...
  pListCmd = new G4UIcmdWithAString("/DMPX/phys/InitializePhysics", this);
  ...
  addParamCmd = new G4UIcmdWithoutParameter("/DMPX/phys/AddParametrisation", this);
  addParamCmd->SetGuidance("Add the parametrisation");
  addParamCmd->AvailableForStates(G4State_PreInit);

  lowLimitECmd = new G4UIcmdWithADoubleAndUnit("/DMPX/phys/setLowLimitE", this);
