...
class HeedModel : public G4VFastSimulationModel {
    ...
    protected:
        ...
        // Gas and ion mobility files
        G4String gasFile;
        G4String ionMobFile;
        
        // Andodes and cathodes variables
        G4double vAnodeWires;
        G4double vCathodePlane;
        G4double vAnodeWires_temp; // To see wheter the variable changed during the simulation
        ...
        G4int numberOfEvents; // Number of secondary electrons tracked

        const char* name; // Name for the model that derives from HeedModel
    ...
    private:
        ...
        // Class for the electric and magnetic field
        ...
        // Variables for anodes and cathodes
