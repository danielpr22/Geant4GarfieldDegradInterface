...
class GasModelParameters{
	public:
        ...
        // Name of the Magboltz file to be used (if needed) and the particle map
        ...
        // Determines the drifting method
	...
	private:
        ...
        // The particle map for the gas and the anodes will be the same
        MapParticlesEnergy fMapParticlesEnergyHeedDeltaElectron; 

        // Gas file and ion mobility variables
        G4String gasFile;
        G4String gasList;
        ...
        // Thermal energy and temperature variables
        G4double thermalE;
        G4double temperature; 

        // Anodes and cathodes variables
